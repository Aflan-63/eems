	...
	var dzChartlist = function () {
		...
		var chartBar = function () {
			if (jQuery('#chart_widget_2').length > 0) {
				...
				chart_widget_2gradientStroke.addColorStop(1, "#ffc76b");
				chart_widget_2gradientStroke.addColorStop(0, "#ffc76b");
				...
				new Chart(chart_widget_1, {
					...
					data: {
						...
						datasets: [{
							...
							borderColor: '#ffc76b',
							pointBackgroundColor: '#ffc76b',
							pointBorderColor: '#ffc76b',
							borderWidth: 6,
							borderRadius: 10,
							pointHoverBackgroundColor: '#ffc76b',
							pointHoverBorderColor: '#ffc76b',
